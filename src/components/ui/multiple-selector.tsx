...
>(
    (
        ...
        const containerRef = React.useRef<HTMLDivElement>(null); // Add container ref
        ...
        return (
            ...
            >
                <div
                    ref={containerRef} // Add ref to container
                    className={cn(
                ...
                <div className="relative">
                    {open && (
                        <CommandList
                            className={cn(
                                'absolute top-1 z-10 rounded-md border bg-popover text-popover-foreground shadow-md outline-none animate-in',
                                // Use the container width instead of w-full
                                'left-0 right-0',
                            )}
                            style={{
                                // Ensure the dropdown matches the container width exactly
                                width:
                                    containerRef.current?.offsetWidth || 'auto',
                            }}
                            onMouseLeave={() => {
